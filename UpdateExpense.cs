...
namespace BTL_LTHSK
{
    public partial class UpdateExpense : Form
    {
        ...
        public UpdateExpense(string id, string amount, string date, string category, string description)
        {
            InitializeComponent();
        ...
        private void savebutton_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "UPDATE tblexpense SET amount = @Amount, date = @Date, category = @Category, description = @Description WHERE id = @ID";
